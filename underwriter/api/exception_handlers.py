...
def handle_exception(f: Callable) -> Callable:
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        except huma_signal_exceptions.HumaSignalException as e:
...
_EXCEPTIONS_TO_HTTP_STATUS_CODES: dict[Type[Exception], int] = {
    huma_signal_exceptions.InvalidAddressException: 400,
    huma_signal_exceptions.PoolSettingsNotFoundException: 404,
}
